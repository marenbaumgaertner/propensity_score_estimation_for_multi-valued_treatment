...
# List of classifiers
classifiers <- c(
  "knn", "knn_radius", "lda", "logit", "multinom",
...
make_calibtation_plot(results$logit$predictions, as_tibble(W_test), "Multinomial Logistic regression (multinom)")
make_calibtation_plot(results$multinom$predictions, as_tibble(W_test), "Multinomial Logistic regression (nnet)")
