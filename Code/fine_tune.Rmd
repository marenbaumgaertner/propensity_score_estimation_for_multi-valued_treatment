...
for (dataname in datanames){
  ...
  for (iter in 1:n_iter) {
    ...
    iter_results$nb_bernulli <- best_nb_bernulli
...
classifiers_tuned <- names(iter_results)
for (c in classifiers_tuned){
  print(c)
  for (i in 1:n_iter){
    print(results[[i]][[c]]$best_params)
  }
}
```
